...
getUrl() {
    case "${arch}" in
        x86_64) echo "https://github.com/pratikchandrani/linutil/releases/latest/download/linutil";;
        *) echo "https://github.com/pratikchandrani/linutil/releases/latest/download/linutil-${arch}";;
    esac
}
